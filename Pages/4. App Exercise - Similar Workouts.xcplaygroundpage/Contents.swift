...
let runWorkout = RunningWorkout(distance: 200, time: 45)
let swimWorkout = SwimmingWorkout(distance: 400, time: 60)

simpleWorkoutDescription(workout: runWorkout)
simpleWorkoutDescription(workout: swimWorkout)
/*:
